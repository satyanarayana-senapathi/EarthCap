    ...
    <footer className="bg-forest-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif font-semibold mb-4">Mycelium Masters</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@myceliummasters.com" className="text-gray-300 hover:text-white transition-colors">
                  info@myceliummasters.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <p className="text-center text-gray-400">
            &copy; {currentYear} Mycelium Masters. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
